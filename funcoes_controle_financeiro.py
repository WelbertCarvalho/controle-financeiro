...
def saldo(receitas, despesas):
	...
	if saldo > 0:
		...
		if comprometido >= 70:
			print('Seu saldo é R$ '+ str(saldo) + ' e está positivo! Porém, você está com ' + str(comprometido) + ' % da sua renda comprometida. Tente reduzir custos.')
		elif (comprometido < 70) & (comprometido >= 50):
			print('Seu saldo é R$ '+ str(saldo) + ' e está positivo! Você está com ' + str(comprometido) + ' % da sua renda comprometida. Sua saúde financeira está regular.')
		elif (comprometido < 50):
			print('Seu saldo é R$ '+ str(saldo) + ' e está positivo e você é um mestre das financas. Está com ' + str(comprometido) + ' % da sua renda comprometida. Nos mostre seu segredo, Mr. M.')
	else:
